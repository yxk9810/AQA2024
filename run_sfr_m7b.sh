#!/bin/bash
#训练sfr-mistra-7b-instruct
embedding_dir=sfr_embeddings
model_path=/mnt/workspace/data/AIME/index/wjd/tevatron/sent_embedding/sentenc_models/SFR-Embedding-Mistral
...
set -f && python -m tevatron.retriever.driver.search \
    ...
    --batch_size 128 \
    --save_text \
    --save_ranking_to results/sfr_7b_top50.txt
