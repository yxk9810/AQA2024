...
class EncoderModel(nn.Module):
    ...
    def build(
        ...
        base_model = cls.TRANSFORMER_CLS.from_pretrained(model_args.model_name_or_path,trust_remote_code=True, **hf_kwargs) if 'Baichuan' in model_args.model_name_or_path else cls.TRANSFORMER_CLS.from_pretrained(model_args.model_name_or_path,**hf_kwargs)
