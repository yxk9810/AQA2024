#!/bin/bash
#训练e5-mistra-7b-instruct
embedding_dir=mis_embeddings
model_path=/mnt/workspace/data/AIME/index/wjd/tevatron/sent_embedding/sentenc_models/e5-mistral-7b-instruct
...
output_dir=retriever-mistral-7b
...
set -f && python -m tevatron.retriever.driver.search \
    ...
    --batch_size 128 \
    --save_text \
    --save_ranking_to results/e5_7b_top50.txt
